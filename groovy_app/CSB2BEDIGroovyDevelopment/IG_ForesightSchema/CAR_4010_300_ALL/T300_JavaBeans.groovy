package cs.b2b.core.mapping.bean.edi.x12.v4010.T300_ALL

public class EDI_ALL_T300 {

	public static final Set<String> MultiElementList = ["Loop_ST","G61","Y6","Loop_Y2","N9","R2A","Loop_N1","N3","Loop_R4","Loop_R4.DTM","H3","EA","Loop_LX","L5","Loop_H1","H2","V1","V9","K1"];
