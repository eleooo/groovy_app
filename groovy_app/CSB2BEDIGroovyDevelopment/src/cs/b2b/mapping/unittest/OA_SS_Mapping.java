...
public class OA_SS_Mapping extends TestBase {

	@Test
	public void test() throws Exception {
		
		String beanCommonFilePath = "./src/cs/b2b/core/mapping/bean/edi/xml/oa/Message.groovy";
		...
		String ediMappingGroovyScriptFileNamePath = "./src/cs/b2b/mapping/scripts/CAR_OCCSSXML_IFTSAI_OA.groovy";
		
		String testInputFileNamePath = "./demo/SS_OA/OOCL_NS_9941248_20151008181626_New.xml";
		...
		String[] runtimeParameters = new String[]{"AppSessionID="+System.currentTimeMillis(), "OriginalSourceFileName="+testInputFile.getName(), "SendPortID=N/A", "PortProperty=N/A", "MSG_REQ_ID=EDI2016081507050979-10", "TP_ID=CMACGM_OA", "MSG_TYPE_ID=SS", "DIR_ID=O"};
