 ...
 * 
 * @author YINEM
 * @pattern after DUMMYBCXML, only filename special
 */
public class CUS_CS2BCXML_XML_YAZAKIPWC {
...
//												}
	...
	String mapping(String inputXmlBody, String[] runtimeParams, Connection conn) {
		...
		if (txnErrorKeys.findAll{it.size == 0}.size != 0) {
			...
			String emailSubject = "[CargoSmart BC data ${bc?.Body[0]?.GeneralInformation?.SCACCode}]"			
			String outputFileName = TP_ID + "_BC_" + MSG_REQ_ID + ".xml"+ emailSubject
