...
/**
 * @author Kieren
 * CHEMSTARDSG CT initialize on 2017/1/16
 */
public class CUS_CS2CTXML_315_CHEMSTARDSG {
	...
	public void generateBody(Body current_Body, MarkupBuilder outXml) {
		...
		def vCS1EventCodeConversion = util.getConversion('CHEMSTARDSG', 'CT', 'O', 'EventStatusCode', vCS1Event, conn)
	...
	String mapping(String inputXmlBody, String[] runtimeParams, Connection conn) {
		...
		Map<String,String> duplicatedPairs = ctUtil.getDuplicatedPairs("CHEMSTARDSG", conn)
		...
		bodies.eachWithIndex { current_Body, current_BodyIndex ->
			...
			def eventExtCde = util.getConversion('CHEMSTARDSG', 'CT', 'O', 'EventStatusCode', eventCS2Cde, conn)
