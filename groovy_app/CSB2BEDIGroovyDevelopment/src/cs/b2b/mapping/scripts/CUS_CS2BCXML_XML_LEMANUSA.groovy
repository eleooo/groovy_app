...
/**
 * xml : copy from 1.0 BCXML app - BCXML_Std, similar and copy from CUS_CS2BCXML_XML_DELMAR.groovy
 *        -- some difference
 *        -- 1, output file name
 *        -- 2, has length conversion in AwkwardCargoDetails
 *        -- 3, output LocationDetails/FacilityCodeName
 *        -- 4, output DocumentInformation
 *        -- 5, address has filtering: Filter Address 1 if same as Facility Name
 *        -- 6, output CarrierCustomerCode
 *        -- 7, VoyageNumberDirection is EnableExternalVoyage
 *        
 *        
 ...
 * 
 */
public class CUS_CS2BCXML_XML_LEMANUSA {
