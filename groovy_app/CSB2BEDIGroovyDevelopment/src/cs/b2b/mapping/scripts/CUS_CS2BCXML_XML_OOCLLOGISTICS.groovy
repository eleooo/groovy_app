 ...
 *xml old std. for OLL
 *@author RENGA
 *@change CSEDI6637  http://i2isd/sites/csisa/Lists/Workplan/DispForm.aspx?ID=29865
 *@change B2BSCR20170626004090c - Remove Approval Code Mapping in B2B BC XML Std (All BCXML), http://i2isd/sites/csisa/Lists/Workplan/DispForm.aspx?ID=31412
 *
 */
public class CUS_CS2BCXML_XML_OOCLLOGISTICS {
					...
					'EquipmentInformation' {
						current_Body.ContainerGroup?.Container?.each { current_Container ->
							'Containers' {
								...
								def defCntrType = current_Container.CSContainerSizeType
