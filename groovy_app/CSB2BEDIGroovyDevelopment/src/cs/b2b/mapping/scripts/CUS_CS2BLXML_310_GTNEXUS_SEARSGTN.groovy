 ...
 */
public class CUS_CS2BLXML_310_GTNEXUS_SEARSGTN {
	...
	List<Map<String,String>> prepValidation(cs.b2b.core.mapping.bean.bl.Body current_Body, int current_BodyIndex){
		...
		List<String> filterPartyNameList = ["LAND'S END", "LANDS END", "LANDS' END"]
		blUtil.filterByPartyName(current_Body,  false, null, errorKeyList, filterPartyNameList)
		List<String> filterSapIDList = ['3135403000','3135403001']
		blUtil.filterBySapID(current_Body,  false, null, errorKeyList, filterSapIDList)
