 ...
 */
public class CUS_CS2CTXML_315_JCPENNYYUSEN{
	...
	public void generateBody(Body current_Body, MarkupBuilder outXml) {
		...
		def vCS1EventCodeConversion = util.getConversion('JCPENNYYUSEN', 'CT', 'O', 'EventStatusCode', vCS1Event, conn)

		def shipDir = util.getEDICdeReffromIntCde('JCPENNYYUSEN','ShipDirection','O','INTCTXML','Q2','EventStatusCode',vCS1Event,conn)
	...
	String mapping(String inputXmlBody, String[] runtimeParams, Connection conn) {
		...
		bodies.eachWithIndex { current_Body, current_BodyIndex ->
			...
			def eventExtCde = util.getConversion('JCPENNYYUSEN', 'CT', 'O', 'EventStatusCode', eventCS2Cde, conn)
