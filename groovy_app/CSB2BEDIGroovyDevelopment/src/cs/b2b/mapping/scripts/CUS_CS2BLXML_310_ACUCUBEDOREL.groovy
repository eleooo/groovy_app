...
/**
* @author XIEMI
* @pattern after TP=HDYOW, KODAKNNR
*/
public class CUS_CS2BLXML_310_ACUCUBEDOREL {
	...
	List<Map<String,String>> prepValidation(cs.b2b.core.mapping.bean.bl.Body current_Body, int current_BodyIndex){
		...
		blUtil.amendments_C(current_Body, false, "No amendments will be sent", errorKeyList)
	...
	void pospValidation(String outputXml, List<Map<String,String>> errorKeyList){
		...
		blUtil.checkMissingL1_2(node, false, null, errorKeyList)  //No L1_2
	...
	void syntaxValidation(String outputXml, List<Map<String,String>> errorKeyList){
		...
		blUtil.checkQTY02_QTY04_C(node, true, null, errorKeyList)  //At least one of QTY02 or QTY04 is required.
		...
		blUtil.checkL008_L009_P(node, true, null, errorKeyList)  //Either L008 L009 exists then all are required
