...
/**
 * @author Kieren
 * CARGOLUTIONDSG CT initialize on 2017/1/16
 */
public class CUS_CS2CTXML_315_CARGOLUTIONDSG {
	...
	public void generateBody(Body current_Body, MarkupBuilder outXml) {
		...
		def vCS1EventCodeConversion = util.getConversion('CARGOLUTIONDSG', 'CT', 'O', 'EventStatusCode', vCS1Event, conn)
	...
	String mapping(String inputXmlBody, String[] runtimeParams, Connection conn) {
		...
		Map<String,String> duplicatedPairs = ctUtil.getDuplicatedPairs("CARGOLUTIONDSG", conn)
		...
		bodies.eachWithIndex { current_Body, current_BodyIndex ->
			...
			def eventExtCde = util.getConversion('CARGOLUTIONDSG', 'CT', 'O', 'EventStatusCode', eventCS2Cde, conn)
