 ...
 *             -- difference
 *             -- 1, Container SizeType, ContainerType use CS1ContainerSizeType
 *             
 ...
 * 
 */
public class CUS_CS2BCXML_XML_SINOTRANSGD {
...
//													}
	...
	String mapping(String inputXmlBody, String[] runtimeParams, Connection conn) {
		...
		if (txnErrorKeys.findAll{it.size == 0}.size != 0) {
			...
			String outputFileName = "BCXML_" + TP_ID + "_" + currentDate.format(yyyyMMddHHmmss) + fileSeqStr + ".xml"
