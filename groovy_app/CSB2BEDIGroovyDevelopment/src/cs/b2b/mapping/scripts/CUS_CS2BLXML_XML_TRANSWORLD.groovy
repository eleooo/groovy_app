 ...
 * @pattern after WGLL
 */
public class CUS_CS2BLXML_XML_TRANSWORLD {
...
//									if (current_OceanLeg?.SVVD?.Loading) {
										'VesselVoyageInformation' {
											...
											'VesselInformation' {
												'VesselCode' ('null':'true', 'CallSign':current_OceanLeg?.SVVD?.Loading?.CallSign, current_OceanLeg?.SVVD?.Loading?.Vessel,'LloydsCode':current_OceanLeg?.SVVD?.Loading?.LloydsNumber,)
