 ...
 */
public class CUS_CS2BLXML_310_GTNEXUS_DELMONTE {
	...
	List<Map<String,String>> prepValidation(cs.b2b.core.mapping.bean.bl.Body current_Body, int current_BodyIndex){
		...
		blUtil.nonUSinFND(false, 'Must be inbound to US', errorKeyList, current_Body)
		blUtil.NonUSinPOD(false, 'Must be inbound to US', errorKeyList, current_Body)
		return errorKeyList;
	}
