 ...
 * @pattern after TP=FRIESLANDGTN,SEARSGTN
 */
public class CUS_CS2BLXML_310_GTNEXUS_LANDSENDGTN {
	...
	public void generateBody(Body current_Body, Map<cs.b2b.core.mapping.bean.bl.Container, List<cs.b2b.core.mapping.bean.bl.Cargo>> associateContainerAndCargo,List<FreightCharge> filteredFreightCharge, List<FreightChargeCNTR> filteredFreightChargeCNTR, MarkupBuilder outXml) {
		...
		outXml.'Loop_ST' {
			...
			Map<String, String> referenceCodeCS2Map = ['CR' :'CG','FR':'FN', 'SC':'CT', 'SID':'SI']
			Map<String, String> referenceRemarkCS2Map = ['CR' : 'CUSTOMER REFERENCE NUMBER', 'FR':'FORWARDER REFERENCE', 'SC':'CONTRACT NUMBER', 'SID':'Shipper\'s Identifying Number for Shipment (SID)']
	...
	List<Map<String,String>> prepValidation(cs.b2b.core.mapping.bean.bl.Body current_Body, int current_BodyIndex){
		...
		List<String> noRegisteredSapIDList = ['3034498000', '4095038000', '4218509000', '4311413000', '4320701000', '4328247000', '4343463000', '6451500000', '6527375000', '6605439000', '6609684000', '6886343000', '6951172000', '6990781000', '7059092000', '7097735000', '7135015000', '7163500000']
		blUtil.filterByNoRegisteredSapID(current_Body,  false, null, errorKeyList, noRegisteredSapIDList)
