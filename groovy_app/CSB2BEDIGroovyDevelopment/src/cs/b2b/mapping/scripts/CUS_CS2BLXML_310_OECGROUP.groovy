...
*/
public class CUS_CS2BLXML_310_OECGROUP {
	...
	void pospValidation(String outputXml, List<Map<String,String>> errorKeyList){
		...
		blUtil.checkL102LengthWithPoint(node, 9, true, null, errorKeyList)
		blUtil.checkL0Max(node,120, true, null, errorKeyList)
		blUtil.checkH1_FlashPoint(node,true, null, errorKeyList)
//		blUtil.checkL102L106L307Checker(node,true, null, errorKeyList)    //flow.xml no this
