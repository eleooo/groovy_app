...
/**
 * @author Amy
 * By BROOKSPORTSGTN(Copy from GTNSTD3) CT as standard GTN5 Script initialize on 20170629
 * difference between GTNSTD3 and GTNSTD5:
 * GTNSTD3: has exception FilterEventSentToCustomer
 * GTNSTD5: no exception FilterEventSentToCustomer
 */
public class CUS_CS2CTXML_315_GTNSTD5 {
