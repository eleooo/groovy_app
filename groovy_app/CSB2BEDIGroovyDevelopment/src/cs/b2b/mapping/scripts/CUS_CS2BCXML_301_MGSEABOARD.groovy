...
/**
 * @author YINEM
 * @pattern after TP = MITSUISOKOTRADE [only reference diff]
 */
public class CUS_CS2BCXML_301_MGSEABOARD {
	...
	//Tibco hidden bug for "BKG "
	Map<String,String> referenceTypeMap = ['BL':'BM','BKG ':'BN','INV':'IN','CR':'CR', 'CTR':'CT', 'FM':'FM', 'FR':'FN', 'PO':'PO', 'PR':'Q1', 'RP':'RP', 'SC':'E8', 'SID':'SI', 'SO':'SO', 'SR':'SR', 'TARIF':'TS']
