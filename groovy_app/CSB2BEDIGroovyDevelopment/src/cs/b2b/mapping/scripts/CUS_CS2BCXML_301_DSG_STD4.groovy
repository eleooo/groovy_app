 ...
 * 
 * @author YINEM
 * shared by FRACHTIES/IESEG/JOHNJAMESIES/MACDSG, pattern after STD1
 */
public class CUS_CS2BCXML_301_DSG_STD4 {
	...
	Map<String,String> referenceTypeMap = ['BL':'BM','CR':'CR', 'CTR':'CT', 'FR':'FN', 'ICR':'CR', 'INV':'IN', 'PO':'PO', 'QUOT':'Q1', 'SC':'E8', 'SID':'SI', 'SO':'SO', 'SR':'SR']
...
//				prepValidation(current_Body, current_BodyIndex,errorKeyList)	
	...
	void pospValidation(Body current_Body, String outputXml, List<Map<String,String>> errorKeyList){
		...
		bcUtil.checkB102MandatoryForDeclined(current_Body,node, true, null, errorKeyList)		
