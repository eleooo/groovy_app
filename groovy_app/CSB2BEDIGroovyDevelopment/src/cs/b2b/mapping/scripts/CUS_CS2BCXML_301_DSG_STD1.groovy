 ...
 * 
 * @author YINEM
 * shared by EUROFRETDSG,DLSLOGDSG,HERBALIFEVIADSG, pattern after MITSUISOKOTRADE
 */
public class CUS_CS2BCXML_301_DSG_STD1 {
	...
	Map<String,String> referenceTypeMap = ['BL':'BM','CR':'CR', 'CTR':'CT', 'ICR':'CR', 'INV':'IN', 'PO':'PO', 'QUOT':'Q1', 'SC':'E8', 'SID':'SI', 'SO':'SO']
