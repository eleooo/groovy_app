 ...
 */
public class CUS_CS2BCXML_301_MITSUISOKOTRADE {
	...
	Map<String,String> referenceTypeMap = ['BL':'BM','CIN':'IN','CR':'CR', 'CTR':'CT', 'FM':'FM', 'FR':'FN', 'PO':'PO', 'PR':'Q1', 'RP':'RP', 'SC':'E8', 'SID':'SI', 'SO':'SO', 'SR':'SR', 'TARIF':'TS']
