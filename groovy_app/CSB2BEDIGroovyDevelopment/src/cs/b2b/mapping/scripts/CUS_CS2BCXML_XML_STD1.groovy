...
/**
 * -- in initial stage, THITIANJIN and WGLL has use this script
 * 
 * xml : copy from 1.0 BCXML app - BCXML_Std, similar and copy from CUS_CS2BCXML_XML_LEMANUSA.groovy
 *        -- some difference
 *        -- 1, Container SizeType, ContainerType container size type query use SCAC
 *        -- 2, output file name
 *
 ...
 *
 */
public class CUS_CS2BCXML_XML_STD1 {
...
//													}
	...
	String mapping(String inputXmlBody, String[] runtimeParams, Connection conn) {
		...
		if (txnErrorKeys.findAll{it.size == 0}.size != 0) {
			...
			String outputFileName = TP_ID + "_BCXML_" + msgReqId + ".xml"
