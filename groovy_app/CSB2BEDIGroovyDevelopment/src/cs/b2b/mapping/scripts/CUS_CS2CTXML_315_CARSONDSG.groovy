...
public class CUS_CS2CTXML_315_CARSONDSG {
	...
	public void generateBody(Body current_Body, MarkupBuilder outXml) {
		...
		def vCS1EventCodeConversion = util.getConversion('CARSONDSG', 'CT', 'O', 'EventStatusCode', vCS1Event, conn)
	...
	String mapping(String inputXmlBody, String[] runtimeParams, Connection conn) {
		...
		Map<String,String> duplicatedPairs = ctUtil.getDuplicatedPairs("CARSONDSG", conn)
		...
		bodies.eachWithIndex { current_Body, current_BodyIndex ->
			...
			def eventExtCde = util.getConversion('CARSONDSG', 'CT', 'O', 'EventStatusCode', eventCS2Cde, conn)
