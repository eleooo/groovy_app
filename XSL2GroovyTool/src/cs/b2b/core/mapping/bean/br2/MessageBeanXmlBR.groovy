package cs.b2b.core.mapping.bean.br2
...
class Booking implements Serializable {
	public static final Set<String> MultiElementList = ['References', 'AddressLines', 'Party', 'RouteInformation.Location', 'Intermodal.Location', 'Intermodal', 'Appointment', 'CargoDetails.Weight','HazardousMaterial.Weight', 'Containers', 'RemarksLines', 'DangerousCargoInfo', 'AwkwardCargoInfo', 'CargoDetails', 'SpecialHandling', 'Request','DangerousCargoInfo.EmergencyContact','SummaryDetails.Remarks'];
...
@JsonAdapter(EmptyPickupDateAdapter.class)
...
@JsonAdapter(FullReturnDateAdapter.class)
...
@JsonAdapter(AppointmentDateAdapter.class)
...
@JsonAdapter(EmptyReturnDateAdapter.class)
...
@JsonAdapter(DestinationDateTimeAdapter.class)
...
@JsonAdapter(CommodityAdapter.class)
...
@JsonAdapter(InnerPackagingAdapter.class)
...
@JsonAdapter(OuterPackagingAdapter.class)
...
class EmptyPickupDateAdapter extends TypeAdapter<EmptyPickupDate> {
...
class FullReturnDateAdapter extends TypeAdapter<FullReturnDate> {
...
class AppointmentDateAdapter extends TypeAdapter<AppointmentDate> {
...
class EmptyReturnDateAdapter extends TypeAdapter<EmptyReturnDate> {
...
class DestinationDateTimeAdapter extends TypeAdapter<DestinationDateTime> {
...
class CommodityAdapter extends TypeAdapter<Commodity> {
...
class InnerPackagingAdapter extends TypeAdapter<InnerPackaging> {
...
class OuterPackagingAdapter extends TypeAdapter<OuterPackaging> {
